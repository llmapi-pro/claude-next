...
Protocol:
  ...
  - When context feels full or you've reached a natural checkpoint, include the
    marker [ROTATE] somewhere in your reply. The orchestrator will then ask you
    to run /next and will start a fresh window reading the handoff.
  - When the entire task is complete, include the marker [DONE].
